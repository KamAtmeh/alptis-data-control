...
Test Coherence Lien Pere
    ...
    toolbox.write_csv   ${result}    ${fp_result_contrat}    ${directory_output_PM01}    FLAG_COHERENCE_CONTRAT_    a    ${True}
...
Test Lien Fonctionnel GMA TMAD
    ...
    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_PM01}    FLAG_COHERENCE_SSCC_    a    ${True}
...
Test Lien Fonctionnel GMA SOR
    ...
    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_PM01}    FLAG_COHERENCE_SGAR_    a    ${True}
...
Test Existence Enregistrement Contrat Couv-Coti
    ...
    toolbox.write_csv   ${result_contrat_cc}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_COUV_COTI_    a    ${True}
...
Test Existence Enregistrement Contrat Garantie
    ...
    toolbox.write_csv   ${result_con_gar}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_GARANTIE_    a    ${True}
...
Test Existence Enregistrement Risque Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_RISQUE_    a    ${True}
...
Test Existence Enregistrement RisqueSL Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_RISQUE_SL_    a    ${True}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Existence Enregistrement ContratSL Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_CONTRAT_SL_    a    ${False}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Controle Couv-Coti et Garantie
    ...
    toolbox.write_csv    ${result_sgar}    ${fp_result_sgar}    ${directory_files_PM01}    FLAG_LINE_NOT_IN_SSCC_
