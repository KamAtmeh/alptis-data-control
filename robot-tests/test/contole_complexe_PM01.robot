...
Test Coherence Lien Pere
    ...
    toolbox.write_csv   ${result}    ${fp_result_contrat}    ${directory_output_PM01}    FLAG_COHERENCE_CONTRAT_    w    ${True}
...
Test Lien Fonctionnel GMA TMAD
    ...
    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_PM01}    FLAG_COHERENCE_SSCC_    w    ${True}
...
Test Lien Fonctionnel GMA SOR
    ...
    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_PM01}    FLAG_COHERENCE_SGAR_    w    ${True}
...
Test Existence Enregistrement Contrat Couv-Coti
    ...
    toolbox.write_csv   ${result_contrat_cc}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_COUV_COTI_    w    ${True}
    toolbox.write_csv   ${result_cc_contrat}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_COUV_COTI_    a    ${False}
...
Test Existence Enregistrement Contrat Garantie
    ...
    toolbox.write_csv   ${result_con_gar}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_GARANTIE_    w    ${True}
    toolbox.write_csv   ${result_gar_con}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_GARANTIE_    a    ${False}
...
Test Existence Enregistrement Risque Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_RISQUE_    w    ${True}
...
Test Existence Enregistrement RisqueSL Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_RISQUE_SL_    w    ${True}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Existence Enregistrement ContratSL Contrat
    ...
    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_PM01}    FLAG_CONTRAT_CONTRAT_SL_    w    ${False}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Controle Couv-Coti et Garantie
    ...
    toolbox.write_csv    ${result_sscc}    ${fp_result_sscc}    ${directory_output_PM01}    FLAG_LINE_NOT_IN_SGAR_
    toolbox.write_csv    ${result_sgar}    ${fp_result_sgar}    ${directory_output_PM01}    FLAG_LINE_NOT_IN_SSCC_
