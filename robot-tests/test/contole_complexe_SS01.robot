...
Test Coherence Lien Pere
    ...
    Run Keyword If     ${result.__len__()} > 0    toolbox.write_csv   ${result}    ${fp_result_contrat}    ${directory_output_SS01}    FLAG_COHERENCE_CONTRAT_    a    ${True}
...
Test Lien Fonctionnel GMA TMAD
    ...
    Run Keyword If     ${result_data.__len__()} > 0    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_SS01}    FLAG_COHERENCE_SSCC_    a    ${True}
...
Test Lien Fonctionnel GMA SOR
    ...
    Run Keyword If     ${result_data.__len__()} > 0    toolbox.write_csv    ${result_data}    ${fp_result_gma}    ${directory_output_SS01}    FLAG_COHERENCE_SGAR_    a    ${True}
...
Test Existence Enregistrement Risque Contrat
    ...
    Run Keyword If     ${result.__len__()} > 0    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_SS01}    FLAG_CONTRAT_RISQUE_    a    ${True}
...
Test Existence Enregistrement RisqueSL Contrat
    ...
    Run Keyword If     ${result.__len__()} > 0    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_SS01}    FLAG_CONTRAT_RISQUE_SL_    a    ${True}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Existence Enregistrement ContratSL Contrat
    ...
    Run Keyword If     ${result.__len__()} > 0    toolbox.write_csv   ${result}    ${fp_existence_result}    ${directory_output_SS01}    FLAG_CONTRAT_CONTRAT_SL_    a    ${False}
    Should Be Empty    ${result}    Des valeurs dans l'ensemble à droite ne sont pas dans l'ensemble à gauche. ${\n} ${result}
...
Test Controle Couv-Coti et Garantie
    ...
    Run Keyword If     ${result_sscc.__len__()} > 0    toolbox.write_csv    ${result_sscc}    ${fp_result_sscc}    ${directory_output_SS01}    FLAG_LINE_NOT_IN_SGAR_
    Run Keyword If     ${result_sgar.__len__()} > 0    toolbox.write_csv    ${result_sgar}    ${fp_result_sgar}    ${directory_output_SS01}    FLAG_LINE_NOT_IN_SSCC_
